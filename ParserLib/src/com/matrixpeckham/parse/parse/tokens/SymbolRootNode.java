...
public class SymbolRootNode extends SymbolNode {
    ...
    protected final void init() {
        ...
        for (char i = 0; i < len; i++) {
            children.add(i, new SymbolNode(this, i));
            children.get(i).setValid(true);
        }
    }
     ...
     *
     * @param first the first character of this symbol, already read from the
     * reader
     *
     * @return a symbol string from a reader
    ...
    private static final Logger LOG
            = Logger.getLogger(SymbolRootNode.class.getName());

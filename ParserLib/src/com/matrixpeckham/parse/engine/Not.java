 ...
 * </code> which will bind uninstantiated <code>X</code> to <code>jim</code>
 * every time. Thus <code>married(X)</code> will always be true,
 * <code>not married(X)</code> will always be false, and there are no bad
 * bachelors, which is untrue. The good rule instantiates <code>X</code> to a
 * good candidate first, and the negation will prove or disprove itself for that
 * candidate.
 * <p>
...
public class Not extends Structure {
     ...
     *
     * @param s the structure to negate
     */
    ...
    private static final Logger LOG = Logger.getLogger(Not.class.getName());

...
public class RegularExpressionException extends Exception {
    ...
    /**
     * Constructs a <code>RegularExpressionException</code> with no detail
     * message.
     */
    ...
    /**
     * Constructs a <code>RegularExpressionException</code> with the specified
     * detail message.
     *
    ...
    private static final Logger LOG
            = Logger.getLogger(RegularExpressionException.class.getName());

 ...
 * @version 1.0
 */
public class PlusAssembler extends Assembler<Token, Double, NullCloneable> {

    /**
     * Pop two numbers from the stack and push their sum.
     *
     * @param a Assembly the assembly whose stack to use
     */
    @Override
    ...
    private static final Logger LOG
            = Logger.getLogger(PlusAssembler.class.getName());

...
import static com.matrixpeckham.parse.examples.arithmetic.ArithmeticParser.value;
...
public class ShowArithmeticParser {
    ...
    private static void eval(String s, double d)
        ...
        System.out.println("Given: " + s + " Expected: " + d + "\tFound: "
                + value(s));
    }
     ...
     * @param args
     * @throws
     * com.matrixpeckham.parse.examples.arithmetic.ArithmeticExpressionException
     */
    ...
    private static final Logger LOG
            = Logger.getLogger(ShowArithmeticParser.class.getName());

 ...
 */
/**
 * This interface defines the role of a speller, that returns the proper
 * spelling of a class or variable name, given any spelling. For example, a
 * speller might convert CUSTOMERID and customerId to CustomerId. A speller can

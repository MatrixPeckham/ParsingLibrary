 ...
 */
/**
 * This assembler pops a string, and sets the target coffee's country to this
 * string.
 *
 ...
 * @version 1.0
 */
public class CountryAssembler extends Assembler<Token, NullCloneable, Coffee> {
    ...
    private static final Logger LOG
            = Logger.getLogger(CountryAssembler.class.getName());

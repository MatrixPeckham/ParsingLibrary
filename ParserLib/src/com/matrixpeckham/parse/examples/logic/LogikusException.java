...
public class LogikusException
    ...
    /**
     * Constructs a <code>LogikusException</code> with no detail message.
     */
    ...
    /**
     * Constructs a <code>LogikusException</code> with the specified detail
     * message.
     *
    ...
    private static final Logger LOG
            = Logger.getLogger(LogikusException.class.getName());
